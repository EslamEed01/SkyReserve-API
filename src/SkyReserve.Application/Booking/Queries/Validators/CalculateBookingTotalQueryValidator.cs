...
{
    public class CalculateBookingTotalQueryValidator : AbstractValidator<CalculateBookingTotalQuery>
    {
        private readonly IFlightRepository _flightRepository;

        public CalculateBookingTotalQueryValidator(IFlightRepository flightRepository)
        {
            ...
            RuleFor(x => x.PassengerCount)
                ...
                .WithMessage("Passenger count cannot exceed 10 per booking.");
        }
